...
<div class="row">
	<?php
      ...
      <div class ="col-sm-3" id ="select_user">
          <?php
            ...
            while($row_user = mysqli_query_array($run_user)){
    ...
    <div class="col-sm-6">
        <div class = "load_msg" id="scroll_messages">
            <?php
              $sel_msg = "select * from user_messages where (user_to = '$user_to msg'
              AND user_from='$user_form_msg')" OR (user_from='$user_to_msg' AND user_to='$user_from_msg') ORDER by 1 ASC";
              ...
              while($row_msg = mysqli_fetch_array($run_msg)){
                ...
                <div id="loaded_msg">
                   ...
                   $user_form_msg){ echo"<div class='message' id='blue' data-toggle='tooltip' title='$msg_date'>$msg_body</div><br><br><br>" ;}
                   else if($user_from == $user_to_msg AND $user_to ==
                   $user_from_msg ){echo"<div class = 'message' id='green'
                    data-toggle='tooltip' title='$msg_date'></div>";}?></p>
                </div>
