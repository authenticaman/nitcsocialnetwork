...
<div class="row">
	<div class="col-sm-12">
		<div class="main-content">
			<div class="header">
				<h2 style="text-align: center;"><strong>Join NITC Social Network</strong></h2>
				<hr>
			</div>
			<div class="l-part">
				<form action="" method="post">
					...
					<div class="input-group">
						...
						<input id="email" type="email" class="form-control" placeholder="Email" name="u_email" required required pattern =".+@nitc\.ac\.in">
					</div><br>
					<div class="input-group">
					...
					<a style="text-decoration: none;float: right;color: #2994c2;"  title="Signin" href="signin.php">Already have an account?</a><br><br>
