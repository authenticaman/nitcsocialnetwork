...
<div class="row">
	<div class="col-sm-12">
		<div class="main-content">
			<div class="header">
				<h3 style="text-align: center;"><strong>Login to NITC Social Network</strong></h3>
			</div>
			<div class="l-part">
				<form action="" method="post">
					...
					<div class="overlap-text">
						...
						<a style="text-decoration:none;float: right;color: #2994c2;" data-toggle="tooltip" title="Reset Password" href="forgot_password.php">Forgot?</a>
					</div>
					<a style="text-decoration: none;float: right;color: #2994c2;" data-toggle="tooltip" title="Create Account!" href="signup.php">Don't have an account?</a><br><br>
